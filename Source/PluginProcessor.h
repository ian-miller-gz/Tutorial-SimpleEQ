...
private:
        ...
        const Slope& slope)
    {
        ...
        switch (slope)
        {
            case Slope_48: update<3>(cut, coefficients);
            case Slope_36: update<2>(cut, coefficients);
            case Slope_24: update<1>(cut, coefficients);
            case Slope_12: update<0>(cut, coefficients);
        }
    }
